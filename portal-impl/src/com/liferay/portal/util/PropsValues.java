...
public class PropsValues {
	...
	public static final boolean MESSAGE_BOARDS_EMAIL_REMOVE_ORIGINAL_MESSAGE = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.MESSAGE_BOARDS_EMAIL_REMOVE_ORIGINAL_MESSAGE));
