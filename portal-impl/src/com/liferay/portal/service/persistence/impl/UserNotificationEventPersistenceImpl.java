...
public class UserNotificationEventPersistenceImpl extends BasePersistenceImpl<UserNotificationEvent>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A_D = new FinderPath(UserNotificationEventModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationEventModelImpl.FINDER_CACHE_ENABLED,
			UserNotificationEventImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_A_D",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_A_D = new FinderPath(UserNotificationEventModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationEventModelImpl.FINDER_CACHE_ENABLED,
			UserNotificationEventImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByU_A_D",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Boolean.class.getName()
			},
			...
			UserNotificationEventModelImpl.DELIVERED_COLUMN_BITMASK |
			UserNotificationEventModelImpl.TIMESTAMP_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_U_A_D = new FinderPath(UserNotificationEventModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationEventModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_A_D",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Boolean.class.getName()
			});
	...
	/**
	 * Returns all the user notification events where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * @param userId the user ID
	 ...
	 */
	@Override
	public List<UserNotificationEvent> findByU_A_D(long userId,
		boolean actionRequired, boolean delivered) {
		return findByU_A_D(userId, actionRequired, delivered,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the user notification events where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.model.impl.UserNotificationEventModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<UserNotificationEvent> findByU_A_D(long userId,
		boolean actionRequired, boolean delivered, int start, int end) {
		return findByU_A_D(userId, actionRequired, delivered, start, end, null);
	}

	/**
	 * Returns an ordered range of all the user notification events where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.model.impl.UserNotificationEventModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<UserNotificationEvent> findByU_A_D(long userId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_A_D;
			finderArgs = new Object[] { userId, actionRequired, delivered };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A_D;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U_A_D_USERID_2);

			query.append(_FINDER_COLUMN_U_A_D_ACTIONREQUIRED_2);

			query.append(_FINDER_COLUMN_U_A_D_DELIVERED_2);
	...
	/**
	 * Returns the first user notification event in the ordered set where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * @param userId the user ID
	 * @param actionRequired the action required
	 * @param delivered the delivered
	 ...
	 */
	@Override
	public UserNotificationEvent findByU_A_D_First(long userId,
		boolean actionRequired, boolean delivered,
		OrderByComparator orderByComparator)
		throws NoSuchUserNotificationEventException {
		UserNotificationEvent userNotificationEvent = fetchByU_A_D_First(userId,
				actionRequired, delivered, orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationEvent fetchByU_A_D_First(long userId,
		boolean actionRequired, boolean delivered,
		OrderByComparator orderByComparator) {
		List<UserNotificationEvent> list = findByU_A_D(userId, actionRequired,
	...
	/**
	 * Returns the last user notification event in the ordered set where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * @param userId the user ID
	 * @param actionRequired the action required
	 * @param delivered the delivered
	 ...
	 */
	@Override
	public UserNotificationEvent findByU_A_D_Last(long userId,
		boolean actionRequired, boolean delivered,
		OrderByComparator orderByComparator)
		throws NoSuchUserNotificationEventException {
		UserNotificationEvent userNotificationEvent = fetchByU_A_D_Last(userId,
				actionRequired, delivered, orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationEvent fetchByU_A_D_Last(long userId,
		boolean actionRequired, boolean delivered,
		OrderByComparator orderByComparator) {
		int count = countByU_A_D(userId, actionRequired, delivered);
	...
	/**
	 * Returns the user notification events before and after the current user notification event in the ordered set where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * @param userNotificationEventId the primary key of the current user notification event
	 * @param userId the user ID
	 * @param actionRequired the action required
	 ...
	 */
	@Override
	public UserNotificationEvent[] findByU_A_D_PrevAndNext(
		...
		try {
			...
			array[0] = getByU_A_D_PrevAndNext(session, userNotificationEvent,
					userId, actionRequired, delivered, orderByComparator, true);

			array[1] = userNotificationEvent;

			array[2] = getByU_A_D_PrevAndNext(session, userNotificationEvent,
					userId, actionRequired, delivered, orderByComparator, false);
	...
	protected UserNotificationEvent getByU_A_D_PrevAndNext(Session session,
		UserNotificationEvent userNotificationEvent, long userId,
		boolean actionRequired, boolean delivered,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the user notification events where userId = &#63; and actionRequired = &#63; and delivered = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param actionRequired the action required
	 * @param delivered the delivered
	 */
	@Override
	public void removeByU_A_D(long userId, boolean actionRequired,
		boolean delivered) {
		for (UserNotificationEvent userNotificationEvent : findByU_A_D(userId,
				actionRequired, delivered, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(userNotificationEvent);
		}
	}
	...
	/**
	 * Returns the number of user notification events where userId = &#63; and actionRequired = &#63; and delivered = &#63;.
	 *
	 * @param userId the user ID
	 * @param actionRequired the action required
	 * @param delivered the delivered
	 ...
	 */
	@Override
	public int countByU_A_D(long userId, boolean actionRequired,
		boolean delivered) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_U_A_D;

		Object[] finderArgs = new Object[] { userId, actionRequired, delivered };
	...
	private static final String _FINDER_COLUMN_U_A_D_USERID_2 = "userNotificationEvent.userId = ? AND ";
	private static final String _FINDER_COLUMN_U_A_D_ACTIONREQUIRED_2 = "userNotificationEvent.actionRequired = ? AND ";
	private static final String _FINDER_COLUMN_U_A_D_DELIVERED_2 = "userNotificationEvent.delivered = ?";
	...
	public UserNotificationEvent updateImpl(
		...
		if (isNew || !UserNotificationEventModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((userNotificationEventModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_A_D.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userNotificationEventModelImpl.getOriginalUserId(),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_A_D, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_A_D,
					args);
